...
docker run -it \
  ...
  bash -c "
    ...
    roslaunch pedsim_simulator warehouse_with_robot.launch scene_file:=/environment/scenarios/warehouse_pedsim.xml world_file:=/environment/worlds/warehouse.world
  "
