#!/bin/bash
# ==============================================================================
# 3-Way Comparison Runner - GUI Mode
#
# Robot (DWA only) vs CIGP vs Predictive Planning 비교
# GUI 모드 (화면에서 직접 확인)
#
# Usage:
#   ./run_comparison_3way_gui.sh
# ==============================================================================
...
RESULTS_DIR="${SCRIPT_DIR}/results/comparison_3way_gui_${TIMESTAMP}"

mkdir -p "${RESULTS_DIR}"

echo "=============================================================="
echo " 3-Way Comparison Test - GUI Mode"
echo "=============================================================="
echo ""
...
echo "========================================"
./run_single_experiment.sh --module predictive --episodes 3 2>&1 | tee "${RESULTS_DIR}/predictive_log.txt"
...
echo ""
echo "=============================================================="
echo " 3-WAY COMPARISON RESULTS - GUI Mode"
echo "=============================================================="
